    ...
    return(
      <Card bg="dark" text="light">
          ...
          <Card.Title>{name}</Card.Title>
              <Card.Text><b>Diameter</b> : {planetData ? planetData.result.properties.diameter : <Spinner animation="grow" variant="danger" />}</Card.Text>
              <Card.Text><b>Gravity</b> : {planetData ? planetData.result.properties.gravity : <Spinner animation="grow" variant="warning" />}</Card.Text>
              <Card.Text><b>Climate</b> : {planetData ? planetData.result.properties.climate : <Spinner animation="grow" variant="primary" />}</Card.Text>
              <div className="d-flex d-row justify-content-between">
                  <Link to={`/planetdetails/${planetData?.result.uid}`} className="btn btn-primary">Leer Más</Link>
