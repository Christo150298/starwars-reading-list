    ...
    return(
        <Card bg="dark" text="light" >
            ...
            <Card.Body>
                ...
                <Card.Text><b>Vehicle Class:</b> : {vehicleData ? vehicleData.result.properties.vehicle_class : <Spinner animation="grow" variant="danger" />}</Card.Text>
                <Card.Text><b>Price (credits)</b> : {vehicleData ? vehicleData.result.properties.cost_in_credits : <Spinner animation="grow" variant="warning" />}</Card.Text>
                <Card.Text><b>Passengers</b> : {vehicleData ? vehicleData.result.properties.passengers : <Spinner animation="grow" variant="primary" />}</Card.Text>
                <div className="d-flex d-row justify-content-between">
                    <Link to={`/vehicledetails/${id}`} className="btn btn-primary">Leer Más</Link>
